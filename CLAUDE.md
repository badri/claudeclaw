...
## Memory Recall
Before answering anything about prior work, decisions, preferences, or todos: run memory_search with a relevant query, then use memory_get to pull only the needed lines. Citations: include Source: <path#line> when it helps verify memory snippets.
